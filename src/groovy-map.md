...
{% embed include file="examples/groovy/elements_of_map.groovy" %}

## Get all the keys ina Groovy map

{% embed include file="examples/groovy/keys_of_map.groovy" %}
...
{% embed include file="examples/groovy/sorted_keys_of_map.groovy" %}
...
{% embed include file="examples/groovy/return_map.gvy" %}
